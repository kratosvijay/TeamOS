...
class IpaasSyncJobsScreen extends StatelessWidget {
  const IpaasSyncJobsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('iPaaS Sync Jobs Screen', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text('iPaaS Sync Jobs Screen Panel', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
