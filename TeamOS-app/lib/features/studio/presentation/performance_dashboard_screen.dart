    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text('Performance Dashboard Console', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            const Text('Debug rendering latencies and server endpoint speeds.', style: TextStyle(color: Color(0xFF94A3B8), fontSize: 13)),
