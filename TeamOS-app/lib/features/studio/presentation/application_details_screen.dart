    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text('Application Details Console', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            const Text('Configure EAP application attributes, identifiers, and description metadata.', style: TextStyle(color: Color(0xFF94A3B8), fontSize: 13)),
