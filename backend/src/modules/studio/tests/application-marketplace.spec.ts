...
describe('ApplicationMarketplaceService', () => {
  let service: ApplicationMarketplaceService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<ApplicationMarketplaceService>(ApplicationMarketplaceService);
  });
